...
impl SessionState {
    ...
    pub fn validate_nonce(&mut self, nonce: &str) -> bool {
        ...
        let actual_bytes = parts[2].as_bytes();
        let expected_bytes = expected_hmac.as_bytes();
...
fn pre_init_database(app_data_dir: &std::path::Path) {
    ...
    let migrations: Vec<(i64, &str, &str)> = vec![
        ...
        (24, "Add transferred flag to ordinal_cache", "D9BBEAB56ADC10B45FC64DEDCD2009EB6464A6B523651EF72E37091A0393F597BB82C31CE3812ED9CBB5686095DA3334"),
        (25, "Add block_height to ordinal_cache", "8062395EB91400B958B02073E6142D453FAE027BA14D127767B22B3BCC72D4A2E6782608CC5755D783E821B76B8C4A77"),
    ];
