  ...
  return (
    <div className="baskets-row" role="list" aria-label="Wallet baskets">
      <div className="basket-chip" role="listitem" title="Default balance">
        <span className="basket-chip-icon" aria-hidden="true"><Wallet size={12} strokeWidth={2.5} /></span>
      ...
      <div className="basket-chip" role="listitem" title="Ordinals count">
        <span className="basket-chip-icon" aria-hidden="true"><Image size={12} strokeWidth={2.5} /></span>
      ...
      <div className="basket-chip" role="listitem" title="Identity balance">
        <span className="basket-chip-icon" aria-hidden="true"><Fingerprint size={12} strokeWidth={2.5} /></span>
      ...
      <div className="basket-chip" role="listitem" title="Locked balance">
        <span className="basket-chip-icon" aria-hidden="true"><Lock size={12} strokeWidth={2.5} /></span>
      ...
      {basketBalances.derived > 0 && (
        <div className="basket-chip" role="listitem" title="Derived addresses balance">
          <span className="basket-chip-icon" aria-hidden="true"><GitBranch size={12} strokeWidth={2.5} /></span>
